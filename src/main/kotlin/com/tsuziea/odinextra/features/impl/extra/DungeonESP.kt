...
object DungeonESP : Module(
    ...
    private val mobEnabled by BooleanSetting(
        "Mob",
        true,
        desc = "Highlight starred mobs, bats and withers"
    ).withDependency { mobDropdown }
    ...
    private val doorStyle by SelectorSetting(
        "Door Style",
        "Filled Outline",
        listOf("Filled", "Outline", "Filled Outline"),
        desc = "Style of the box."
    ).withDependency { doorDropdown && doorEnabled }
    ...
    private val chestRenderStyle by SelectorSetting(
        "Mimic Style",
        "Filled Outline",
        listOf("Filled", "Outline", "Filled Outline"),
        "Style of the box."
    ).withDependency { mimicDropdown && mimicEnabled }
